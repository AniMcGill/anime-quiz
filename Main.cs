    ...
    public partial class GameBoard : Form
    {
        ...
        private void createGameToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            if (isSafeOverwrite("There is a game in progress. Do you want to save it before proceeding?"))
            {
                ...
                if (Settings.Default.currentFile != String.Empty && loadFileBehavior(Settings.Default.currentFile))
                    loadGameBehavior();
                else while (gamePanel.Controls.Count > 0) gamePanel.Controls.Clear();
            }
        }
        private void loadGameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (gameLoad.ShowDialog() == DialogResult.OK && loadFileBehavior(gameLoad.FileName))
                loadGameBehavior();
        }
